...
export const REQUIRED_FILES = [
  ...
  // The optional database layer: one fragment per stack.
  "package/templates/databases/typescript/server/prisma/schema.prisma",
  "package/templates/databases/typescript/server/src/db.ts",
  "package/templates/databases/typescript/server/src/items.ts",
  "package/templates/databases/python/server/db.py",
  "package/templates/databases/python/server/models.py",
  "package/templates/databases/python/server/items.py",
  ...
  "package/templates/compose/docker-compose.yml",
  "package/templates/compose/services/postgres.yml",
  "package/templates/compose/services/mysql.yml",
  "package/templates/compose/services/mongodb.yml",
  "package/templates/compose/services/minio.yml",
  "package/templates/databases/mongodb/python/server/db.py",
  "package/templates/databases/mongodb/python/server/items.py",
  "package/templates/databases/mongodb/springboot/server/src/main/java/com/example/app/Item.java",
  "package/templates/storage/typescript/server/src/storage.ts",
  "package/templates/storage/typescript/server/src/files.ts",
  "package/templates/storage/nextjs/lib/storage.ts",
  "package/templates/storage/nextjs/app/api/files/route.ts",
  "package/templates/storage/python/server/storage.py",
  "package/templates/storage/python/server/files.py",
  "package/templates/storage/springboot/server/src/main/java/com/example/app/StorageService.java",
  ...
  // The opt-in auth stub: one implementation per stack.
  "package/templates/auth/typescript/server/src/auth.ts",
  "package/templates/auth/python/server/auth.py",
  "package/templates/auth/springboot/server/src/main/java/com/example/app/AuthService.java",
  "package/templates/auth/springboot/server/src/main/java/com/example/app/AuthController.java",
  "package/templates/auth/nextjs/lib/auth.ts",
  "package/templates/auth/nextjs/app/api/auth/signup/route.ts",
  "package/templates/auth/nextjs/app/api/auth/login/route.ts",
  "package/templates/auth/nextjs/app/api/auth/me/route.ts",
